...
#
#   MakeMaker ARGV: (q[MAKEFILE=Makefile-perl.mk], q[INSTALLDIRS=], q[INSTALL_BASE=/usr/local])
#
#   MakeMaker Parameters:

#     AUTHOR => q[T Jake Luciani <jakers@gmail.com>]
#     NAME => q[Thrift]
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    - T Jake Luciani <jakers@gmail.com>' >> META_new.yml
...
disttest : distdir
	cd $(DISTVNAME) && $(ABSPERLRUN) Makefile.PL "MAKEFILE=Makefile-perl.mk" "INSTALLDIRS=" "INSTALL_BASE=/usr/local"
...
$(FIRST_MAKEFILE) : Makefile.PL $(CONFIGDEP)
	...
	$(PERLRUN) Makefile.PL "MAKEFILE=Makefile-perl.mk" "INSTALLDIRS=" "INSTALL_BASE=/usr/local"
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>T Jake Luciani &lt;jakers@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Bit-Vector" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
